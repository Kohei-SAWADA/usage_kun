...
enum AppTheme {
    static let background = Color(red: 0.015, green: 0.022, blue: 0.018)
    static let header = Color(red: 0.025, green: 0.046, blue: 0.034)
    ...
    static let textFaint = Color(red: 0.35, green: 0.50, blue: 0.39)
}
